...
const zh = {
  ...
  // ── 登入 ──
  identityLabel: '身分識別碼',
  identityPlaceholder: '請輸入 admin 或 Email',
  passwordLabel: '密碼',
  passwordPlaceholder: '請輸入密碼',
  rememberMe: '記住我（下次自動登入）',
  signIn: '登入',
  signingIn: '登入中…',
  errIdentityRequired: '請輸入身分識別碼',
  errPasswordRequired: '請輸入密碼',
  errPasswordMin: '密碼長度至少 4 個字元',
  errLoginFailed: '身分識別碼或密碼錯誤，請重新輸入',
  ...
  // ── 帳號設定 ──
  accountSettingsTitle: '帳號密碼修改',
  accountSettingsDesc: '可將預設帳號改為您常用的 Email，並設定新密碼。',
  currentEmail: '目前登入 Email',
  newEmail: '新 Email',
  ...
  errChangeRequired: '請至少變更 Email 或密碼其中一項',
  errPasswordMismatch: '兩次輸入的新密碼不一致',
  msgAccountUpdated: '帳號已更新。若變更 Email，請留意信箱中的確認信。',
...
const en: Record<keyof typeof zh, string> = {
  ...
  identityPlaceholder: 'Enter admin or Email',
  passwordLabel: 'Password',
  passwordPlaceholder: 'Enter password',
  rememberMe: 'Remember Me',
  signIn: 'Sign In',
  signingIn: 'Signing in…',
  errIdentityRequired: 'Please enter your user ID',
  ...
  accountSettingsTitle: 'Account & Password',
  accountSettingsDesc: 'Update your login email and password.',
  ...
  msgAccountUpdated: 'Account updated. Check your inbox if you changed email.',
