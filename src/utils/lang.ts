...
const zh = {
  ...
  catOperatingMiscDef: '房租、雜貨、檯布、行銷及其他雜支',
  yearEndBonusReserve: '年終獎金儲備（{monthly}/月 × {months} 月）',
  repairFundReserve: '修繕金儲備（{monthly}/月 × {months} 月）',
  repairFundDrawTitle: '修繕金動支紀錄',
  repairFundDrawHint: '實際修繕已由每月修繕金預扣承擔，此處僅供對帳，不計入月損益。',
  repairLedgerTitle: '修繕金動支流水',
  repairLedgerBanner: '此分頁專門記錄實際修繕支出。因每月已預扣修繕金，這裡的金額不會再計入儀表板／報表的月營業支出。',
  repairLedgerHint: '含草稿與已鎖定之修繕動支紀錄',
  repairLedgerEmpty: '尚無修繕動支紀錄',
  repairLedgerEmptyDesc: '請用上方快捷鍵登錄實際修繕支出',
  repairLedgerTotal: '動支合計',
  ...
  chartDetailShare: '佔比',
  chartDetailAmount: '金額',
  chartDetailBreakdown: '廠商／項目明細',
  chartCloseDetail: '關閉',
  chartTapCategoryHint: '點選類別查看佔比、金額與廠商明細',
  drillShortCash: '現金',
...
const en: Record<keyof typeof zh, string> = {
  ...
  repairFundLabel: 'Repair Fund (Monthly)',
  ...
  catOperatingMiscDef: 'Rent, groceries, tablecloths, marketing & other misc.',
  ...
  repairFundDrawHint: 'Actual repairs are covered by the monthly repair reserve; listed here for reconciliation only and excluded from monthly P&L.',
  repairLedgerTitle: 'Repair Fund Draw Ledger',
  repairLedgerBanner: 'Use this tab to log actual repair spending. Because the repair fund is pre-deducted monthly, these amounts are excluded from dashboard/report operating expenses.',
  repairLedgerHint: 'Includes draft and locked repair draw records',
  repairLedgerEmpty: 'No repair draws yet',
  repairLedgerEmptyDesc: 'Use the quick keys above to log actual repair spending',
  repairLedgerTotal: 'Draw total',
  ...
  chartDetailShare: 'Share',
  chartDetailAmount: 'Amount',
  chartDetailBreakdown: 'Vendors / Items',
  chartCloseDetail: 'Close',
  chartTapCategoryHint: 'Tap a category for share, amount, and vendor details',
  drillShortCash: 'Cash',
