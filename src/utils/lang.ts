...
const zh = {
  ...
  catIngredientsDef: '菜金、油條、雞、乾貨、酒水與供應商貨款（惠通、大友等）',
  catLaborDef: 'PT 點工薪資、正職薪資',
  catUtilitiesDef: '電費、瓦斯',
  catRepairDef: '裝潢、冷氣、燈泡等店內修繕與設備維護',
  catOperatingMiscDef: '房租、雜貨、便當盒、檯布、行銷及其他雜支',
  ...
  chartCloseDetail: '關閉',
  chartTapCategoryHint: '點選類別查看佔比與金額',
  drillShortCash: '現金',
...
const en: Record<keyof typeof zh, string> = {
  ...
  catIngredientsDef: 'Produce, fritters, chicken, dry goods, alcohol & vendor payments (e.g. Huitong, Dayou)',
  catLaborDef: 'Part-time wages & full-time salaries',
  catUtilitiesDef: 'Electricity & gas',
  catRepairDef: 'Interior repairs & equipment maintenance (fit-out, A/C, lighting, etc.)',
  catOperatingMiscDef: 'Rent, groceries, lunch boxes, tablecloths, marketing & other misc.',
  ...
  chartTapCategoryHint: 'Tap a category for share and amount',
  drillShortCash: 'Cash',
