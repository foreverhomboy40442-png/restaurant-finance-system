...
const zh = {
  ...
  expenseItemComposition: '支出項目組成',
  unlabeledExpenseItem: '未標示項目',
...
const en: Record<keyof typeof zh, string> = {
  ...
  expenseItemComposition: 'Expense item composition',
  unlabeledExpenseItem: 'Unlabeled item',
